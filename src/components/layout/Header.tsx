                ...
                <div className="md:hidden absolute top-16 left-0 w-full bg-[#fdfcfc] dark:bg-surface-dark border-b border-border-color dark:border-gray-800 shadow-lg animate-fade-in-down z-40">
                    <nav className="flex flex-col p-4 gap-4">
                        ...
                        <div className="flex flex-col gap-4 mt-2 pt-4 border-t border-border-color dark:border-gray-800">
                            <a href="https://wa.me/971503426615" className="flex items-center gap-3 text-green-600 hover:text-green-700 transition-colors p-2 bg-green-50 dark:bg-green-900/10 rounded-lg">
