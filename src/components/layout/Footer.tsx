                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    <div>
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.instagram.com/junko_fze?igsh=cGkwZHI3bXNmMzVt" target="_blank" rel="noopener noreferrer" className="text-blue-200 hover:text-white transition-colors" aria-label="Follow us on Instagram">
                            ...
                            <a href="https://www.facebook.com/share/14P9XxBf6jh/" target="_blank" rel="noopener noreferrer" className="text-blue-200 hover:text-white transition-colors" aria-label="Follow us on Facebook">
                                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 16 16">
